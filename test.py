...
def main(config, iteration):
    ...
    ## using this to eventually make the heatmap
    ...
    trainer.test(iteration)

    
if __name__ == '__main__':
    argparser = argparse.ArgumentParser()
    argparser.add_argument('-c', '--config', default=None, type=str, help='config file path (default: None)')
    argparser.add_argument('--iteration', default=None, type=int, help='iteration to evaluate')
